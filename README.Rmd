...
Below is a simple example of it solving a simple demand profile. And kinda like a maze it goes too far one way before adjusting its path the next time around to a much better solution, less greedy, solution.
